# Generated by Powerlevel10k configuration wizard on 2019-09-02 at 19:14 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 43540.
# Wizard options: powerline, lean, 1 line, sparse, concise.
...
() {
  ...
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,12]//\%/%%}%10F…%10F${VCS_STATUS_LOCAL_BRANCH[-12,-1]//\%/%%}}}'
